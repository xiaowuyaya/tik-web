<template>
  <div>
    <div
      class="flex flex-none h-full container !max-w-s creen-2xl mx-auto px-2 md:px-6"
    >
      <!-- logo -->
      <div class="flex items-center flex-1 font-youshe lg:flex-none">
        <a class="inline-flex items-center text-lg lg:text-2xl" href="/">
          <img
